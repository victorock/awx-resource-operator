# opeator image
IMG_OPERATOR ?= quay.io/victorock/platform-resource-operator:latest
# runner image
IMG_RUNNER ?= quay.io/victorock/platform-resource-runner:latest
# bundle image version
BUNDLE_VERSION ?= 0.1.0
# bundle image
IMG_BUNDLE ?= quay.io/victorock/platform-resource-operator-bundle:$(BUNDLE_VERSION)
